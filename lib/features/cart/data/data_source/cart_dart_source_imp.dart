...
class CartDataSourceImp implements CartDataSourceInterface {
    ...
    try {
      await DioFactory.getDio().post(
        ...
        options: Options(
          headers: {
            'Authorization':
                'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjZhNjc5MDUyOGI3OGVhZTUzZjM0YjdlZSIsImlhdCI6MTc4NTE3MjE1OSwiZXhwIjoxNzg3NzY0MTU5fQ.32knO1kL3TDRCN9luRe3fP19wNxTaFQgles9ca57YT0',
          },
        ),
        data: {
  ...
  @override
  Future<ResultApi<void>> deleteFromCart(CartEntity cartEntity)async {
    try {
...
Future<ResultApi<List<CartEntity>>> getCartItems() async {
  try {
    final response = await DioFactory.getDio().get(
      ...
      options: Options(
        headers: {
          'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjZhNjc5MDUyOGI3OGVhZTUzZjM0YjdlZSIsImlhdCI6MTc4NTE3MjE1OSwiZXhwIjoxNzg3NzY0MTU5fQ.32knO1kL3TDRCN9luRe3fP19wNxTaFQgles9ca57YT0',
        },
      ),
    );
    ...
    final cartItems = list
        .map((e) => CartDto.fromJson(e))
        .toList();
